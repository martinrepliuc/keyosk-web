...
<body>
    ...
    <div id="selective-menu">
        <ul>
            <li>
                <span>Keyosk</span>
                <a class="link-introduction" href="#introduction">View</a>
            </li>
            <li>
                <span>Videos</span>
                <a class="link-video" href="#video">View</a>
            </li>
            <li>
                <span>Slideshows</span>
                <a class="link-slideshow" href="#slideshow">View</a>
            </li>
            <li>
                <span>Subscriptions</span>
                <a class="link-newsletter" href="#newsletter">View</a>
            </li>
            <li>
                <span>Polls</span>
                <a class="link-survey" href="#survey">View</a>
            </li>
            <li>
                <span>Web apps</span>
                <a class="link-webapps" href="#webapps">View</a>
            </li>
            <li>
                <span>Keyosk API</span>
                <a class="link-custom" href="#custom">View</a>
            </li>
            <li>
                <span>Features</span>
                <a class="link-features" href="#features">View</a>
            </li>
        </ul>
    </div>
    ...
    <div id="head">
    	...
    	<!-------------------------------- INTRODUCTION --------------------------------------->
    	<div id="introduction" class="superscroll">
    	...
    	<!-------------------------------- VIDEO ---------------------------------------------->
    	<div id="video" class="superscroll">
    	...
    	<!-------------------------------- SLIDESHOW ------------------------------------------>
    	<div id="slideshow" class="superscroll">
        	<div id="slideshow-bg">
    	...
    	<!-------------------------------- NEWSLETTER ----------------------------------------->
    	<div id="newsletter" class="superscroll">
    	...
    	<!-------------------------------- SURVEY --------------------------------------------->
    	<div id="survey" class="superscroll">
        ...
        <div id="webapps" class="superscroll">
        	...
        	<div class="container">
            	<div class="row">
              		...
              		<div class="span4 app">
                    	<a href="https://22slides.com/" target="_blank"><img src="http://www.keyosk.io/wp-content/themes/keyosk/images/22slides.jpg" /></a>
                    	<h3><a href="https://22slides.com/" target="_blank">22 Slides</a></h3>
                        <p>Meet 22Slides, the website builder that’s helped photographers, designers, and other artists create the website they've always wanted.</p>
                    </div>
                    <br class="clear" />
            	</div><!-- row -->
            </div><!-- container -->
    	...
    	<!-------------------------------- CUSTOM --------------------------------------------->
    	<div id="custom" class="superscroll">
            ...
            A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.
                            ...
                            <li>
                                <div class="container">
                                    <div class="row rowin">
                                        <div class="span7 custom-overlay-image">
                                            <img src="http://www.keyosk.io/wp-content/themes/keyosk/images/api/big-tarifrechner.jpg" />
                                        </div>
                                        <div class="span5 custom-overlay-text">
                                            <h5>Tarifrechner</h5>
                                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.<br /><br />
            ...
            A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.
                            ...
                            <li>
                                <div class="container">
                                    <div class="row rowin">
                                        <div class="span7 custom-overlay-image">
                                            <img src="http://www.keyosk.io/wp-content/themes/keyosk/images/api/big-app-tipps.jpg" />
                                        </div>
                                        <div class="span5 custom-overlay-text">
                                            <h5>App Tipps</h5>
                                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.<br /><br />
            ...
            A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.
                            ...
                            <li>
                                <div class="container">
                                    <div class="row rowin">
                                        <div class="span7 custom-overlay-image">
                                            <img src="http://www.keyosk.io/wp-content/themes/keyosk/images/api/big-selfcare.jpg" />
                                        </div>
                                        <div class="span5 custom-overlay-text">
                                            <h5>Selfcare</h5>
                                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.<br /><br />
            ...
            A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.
                            ...
                            <li>
                                <div class="container">
                                    <div class="row rowin">
                                        <div class="span7 custom-overlay-image">
                                            <img src="http://www.keyosk.io/wp-content/themes/keyosk/images/api/big-sony.jpg" />
                                        </div>
                                        <div class="span5 custom-overlay-text">
                                            <h5>Sony</h5>
                                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.<br /><br />
                    	...
                    	<div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide"> 
                                <div class="imgbox big-imgbox">
                                    ...
                                    <img src="http://www.keyosk.io/wp-content/themes/keyosk/images/api/tarifrechner.jpg" /></div> 
                            </div>
                            <div class="swiper-slide"> 
                                <div class="imgbox big-imgbox">
                                	<a data-slide-index="2" href="" class="open-custom-overlay"></a>
                                    <img src="http://www.keyosk.io/wp-content/themes/keyosk/images/api/app-tipps.jpg" /></div> 
                            </div>
                            <div class="swiper-slide"> 
                                <div class="imgbox big-imgbox">
                                	<a data-slide-index="3" href="" class="open-custom-overlay"></a>
                                    <img src="http://www.keyosk.io/wp-content/themes/keyosk/images/api/selfcare.jpg" /></div> 
                            </div>
                            <div class="swiper-slide"> 
                                <div class="imgbox big-imgbox">
                                	<a data-slide-index="4" href="" class="open-custom-overlay"></a>
                                    <img src="http://www.keyosk.io/wp-content/themes/keyosk/images/api/sony.jpg" /></div> 
                            </div>
                            <div class="swiper-slide"> 
                                <div class="imgbox big-imgbox">
                                	<a data-slide-index="5" href="" class="open-custom-overlay"></a>
                                    <img src="http://www.keyosk.io/wp-content/themes/keyosk/images/api/event-butler.jpg" /></div> 
                            </div>
                            <div class="swiper-slide"> 
                                <div class="imgbox big-imgbox">
                                	<a data-slide-index="6" href="" class="open-custom-overlay"></a>
                                    <img src="http://www.keyosk.io/wp-content/themes/keyosk/images/api/nail-polish.jpg" /></div> 
                            </div>
                            <div class="swiper-slide"> 
                                <div class="imgbox big-imgbox">
                                	<a data-slide-index="7" href="" class="open-custom-overlay"></a>
    	...
    	<!-------------------------------- FEATURES ------------------------------------------->
    	<div id="features" class="superscroll">
    ...
    <script type="text/javascript" src="http://www.keyosk.io/wp-content/themes/keyosk/js/parallax.js"></script>
